...
// чтобы переходить по клику на статью я вытащил из props-а {navigation}
// и снизу во flat list буду говорить, что navigation onPress нужносделать переход ч помощю navigate
			...
			<FlatList
				...
				renderItem={({ item }) => (
					<TouchableOpacity onPress={() => navigation.navigate('fullPost', { id: item.id, title: item.title})} >
						{/* вторым аргументом указал ту инфу, которая перейдет в fulPost 
						в самом fullPostScreen нужно указать в параметр route и вытащить параметры*/}
